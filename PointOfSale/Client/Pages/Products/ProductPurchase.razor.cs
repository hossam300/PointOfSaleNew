...
namespace PointOfSale.Client.Pages.Products
{
    public partial class ProductPurchase : ComponentBase
    {
        ...
        ProductPurchaseDTO product = new ProductPurchaseDTO();
        ...
        {
            product = await Http.GetFromJsonAsync<ProductPurchaseDTO>("api/Products/GetProductPurchaseDTOById/" + id);
        ...
        public async void FormProductSubmit(ProductPurchaseDTO model)
        {
