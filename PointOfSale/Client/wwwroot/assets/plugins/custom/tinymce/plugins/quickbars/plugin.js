...
(function (domGlobals) {
    ...
    var InsertToolbars = { adEditor: adEditor };

    var adEditor$1 = function (editor) {
    ...
    var SelectionToolbars = { adEditor: adEditor$1 };

    function Plugin () {
      global.add('quickbars', function (editor) {
        InsertButtons.setupButtons(editor);
        InsertToolbars.adEditor(editor);
        SelectionToolbars.adEditor(editor);
      });
    }
