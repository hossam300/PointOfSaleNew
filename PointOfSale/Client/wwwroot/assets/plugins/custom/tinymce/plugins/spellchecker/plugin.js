...
(function (domGlobals) {
    ...
    var defaultSpellcheckCallback = function (editor, pluginUrl, currentLanguageState) {
      return function (method, text, doneCallback, errorCallback) {
        ...
        var postData = '';
        data[method === 'adDictionary' ? 'word' : 'text'] = text;
    ...
    var adDictionary = function (editor, pluginUrl, startedState, textMatcherState, currentLanguageState, word, spans) {
      editor.setProgressState(true);
      sendRpcCall(editor, pluginUrl, currentLanguageState, 'adDictionary', word, function () {
        editor.setProgressState(false);
    ...
    var register$1 = function (editor, pluginUrl, startedState, textMatcherState, currentLanguageState, lastSuggestionsState) {
      ...
      if (languageMenuItems.length > 1) {
        ...
        editor.ui.registry.adggleButton('spellchecker', buttonArgs);
      }
      editor.ui.registry.adggleMenuItem('spellchecker', {
        text: 'Spellcheck',
    ...
    var getSuggestions = function (editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState, currentLanguageState, word, spans) {
      ...
      if (hasDictionarySupport) {
        ...
        items.push({
          ...
          onAction: function () {
            Actions.adDictionary(editor, pluginUrl, startedState, textMatcherState, currentLanguageState, word, spans);
          }
        });
      }
