...
(function (domGlobals) {
    ...
    var setup = function (editor, toggleState) {
      var debounceggle = global$1.debounce(function () {
        VisualChars.toggle(editor);
      }, 300);
      if (editor.settings.forced_root_block !== false) {
        editor.on('keydown', function (e) {
          if (toggleState.get() === true) {
            e.keyCode === 13 ? VisualChars.toggle(editor) : debounceggle();
          }
        });
      }
    };
    ...
    var register$1 = function (editor, toggleState) {
      editor.ui.registry.adggleButton('visualchars', {
      ...
      editor.ui.registry.adggleMenuItem('visualchars', {
