...
(function (global, factory) {
    ...
    function appenElement(el, content) {
        var childNodes = normalizeContent(content);
        for (var i = 0; i < childNodes.length; i++) {
            el.appendChild(childNodes[i]);
        }
    }
    function prepenElement(parent, content) {
    ...
    */
    var EmitterMixin = /** @class */ (function (_super) {
        ...
        EmitterMixin.prototype.on = function (type, handler) {
            adHash(this._handlers || (this._handlers = {}), type, handler);
            return this; // for chaining
        };
        // todo: add comments
        EmitterMixin.prototype.one = function (type, handler) {
            adHash(this._oneHandlers || (this._oneHandlers = {}), type, handler);
            return this; // for chaining
        };
    ...
    function adHash(hash, type, handler) {
        (hash[type] || (hash[type] = []))
            .push(handler);
    }
    ...
    */
    ...
    var Toolbar = /** @class */ (function (_super) {
        ...
        Toolbar.prototype.renderLayout = function (layout) {
            ...
            appenElement(el, this.renderSection('left', layout.left));
            appenElement(el, this.renderSection('center', layout.center));
            appenElement(el, this.renderSection('right', layout.right));
        };
            ...
            if (buttonStr) {
                buttonStr.split(' ').forEach(function (buttonGroupStr, i) {
                    ...
                    if (groupChildren.length > 1) {
                        ...
                        appenElement(groupEl, groupChildren);
                        sectionEl.appendChild(groupEl);
                    }
                    else {
                        appenElement(sectionEl, groupChildren); // 1 or 0 children
                    }
                });
            }
            return sectionEl;
    ...
    var CalendarComponent = /** @class */ (function (_super) {
        ...
        CalendarComponent.prototype._renderSkeleton = function (context) {
            ...
            prepenElement(this.el, this.contentEl = createElement('div', { className: 'fc-view-container' }));
        ...
        CalendarComponent.prototype._renderToolbars = function (viewSpec, dateProfile, currentDate, title) {
            ...
            if (headerLayout) {
                if (!header) {
                    ...
                    prepenElement(this.el, header.el);
                }
            ...
            if (footerLayout) {
                if (!footer) {
                    ...
                    appenElement(this.el, footer.el);
                }
    ...
    */
    ...
    exports.appenElement = appenElement;
    ...
    exports.prepenElement = prepenElement;
    ...
    */
    ...
    var DayGridEventRenderer = /** @class */ (function (_super) {
        ...
        DayGridEventRenderer.prototype.renderSegRow = function (row, rowSegs) {
            ...
            for (i = 0; i < levelCnt; i++) { // iterate through all levels
                ...
                if (introHtml) {
                    if (isRtl) {
                        core.appenElement(tr, introHtml);
                    }
                    else {
                        core.prepenElement(tr, introHtml);
                    }
                }
    ...
    var DayGridFillRenderer = /** @class */ (function (_super) {
        ...
        DayGridFillRenderer.prototype.renderFillRow = function (type, seg) {
            ...
            if (introHtml) {
                if (isRtl) {
                    core.appenElement(trEl, introHtml);
                }
                else {
                    core.prepenElement(trEl, introHtml);
                }
            }
            return skeletonEl;
        };
    ...
    */
    var ExternalDraggable = /** @class */ (function () {
        function ExternalDraggable(el, settings) {
            ...
            if (settings.appen != null) {
                dragging.mirror.parentNode = settings.appen; // TODO: write tests
            }
            dragging.emitter.on('pointerdown', this.handlePointerDown);
            dragging.emitter.on('dragstart', this.handleDragStart);
