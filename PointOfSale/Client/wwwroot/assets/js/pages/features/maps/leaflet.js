...
var KTLeaflet = function () {
	...
	var demo1 = function () {
		...
		var marker = L.marker([-37.8179793, 144.9671293], { icon: leafletIcon }).ad(leaflet);
	...
	var demo2 = function () {
		...
		// bind marker with popup
		var marker = L.marker([51.5073219, -0.1276474], { icon: leafletIcon }).ad(leaflet);
	...
	var demo3 = function () {
		...
		var marker1 = L.marker([39.3262345, -4.8380649], { icon: leafletIcon1 }).ad(leaflet);
		var marker2 = L.marker([41.804, 13.843], { icon: leafletIcon2 }).ad(leaflet);
		var marker3 = L.marker([51.11, 10.371], { icon: leafletIcon3 }).ad(leaflet);
		var marker4 = L.marker([46.74, 2.417], { icon: leafletIcon4 }).ad(leaflet);
	...
	var demo4 = function () {
		...
		// bind marker with popup
		var marker = L.marker([51.5, -0.09], { icon: leafletIcon }).ad(leaflet);
	...
	var demo5 = function () {
		...
		// Define Marker Layer
		var markerLayer = L.layerGroup().ad(leaflet);
		...
		leaflet.on('click', function (e) {
			geocodeService.reverse().latlng(e.latlng).run(function (error, result) {
				...
				L.marker(result.latlng, { icon: leafletIcon }).ad(markerLayer).bindPopup(result.address.Match_addr, { closeButton: false }).openPopup();
	...
	var demo6 = function () {
		...
		data.forEach(function (item) {
			var marker = L.marker(item.loc, { icon: leafletIcon }).ad(leaflet);
