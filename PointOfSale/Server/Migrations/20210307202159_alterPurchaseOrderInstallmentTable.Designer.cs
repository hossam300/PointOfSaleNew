...
namespace PointOfSale.Server.Migrations
{
    ...
    [Migration("20210307202159_alterPurchaseOrderInstallmentTable")]
    partial class alterPurchaseOrderInstallmentTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PointOfSale.DAL.Domains.Order", b =>
                {
                    ...
                    b.Property<double>("TotalItemCount")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("PointOfSale.DAL.Domains.PurchaseOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PointOfSale.DAL.Domains.PurchaseOrderInstallment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("PurchaseOrderInstallments");
                });

            modelBuilder.Entity("PointOfSale.DAL.Domains.PurchaseOrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PointOfSale.DAL.Domains.PurchaseOrderPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PointOfSale.DAL.Domains.Shop", b =>
                {
                    ...
                    b.Property<bool>("AdvancedPriceICollections")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("FiscalPositionPerOrder")
                        .HasColumnType("bit");

                    b.Property<bool>("FloorsTables")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("ManualDiscounts")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("SpecificFiscalPosition")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("PointOfSale.DAL.Domains.ShopEmployee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PointOfSale.DAL.Domains.ShopProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ModfiedUserId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PointOfSale.DAL.Domains.Supplier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PointOfSale.DAL.Domains.SupplierContact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PointOfSale.DAL.Domains.PurchaseOrder", b =>
                {
                    ...
                    b.HasOne("PointOfSale.DAL.Domains.Supplier", "Supplier")
            ...
            modelBuilder.Entity("PointOfSale.DAL.Domains.PurchaseOrderInstallment", b =>
                {
                    b.HasOne("PointOfSale.DAL.Domains.PurchaseOrder", "PurchaseOrder")
                        .WithMany("PurchaseOrderInstallments")
            ...
            modelBuilder.Entity("PointOfSale.DAL.Domains.ShopEmployee", b =>
                {
                    ...
                    b.HasOne("PointOfSale.DAL.Domains.SahlUserIdentity", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("PointOfSale.DAL.Domains.ShopPrinter", b =>
                {
                    b.HasOne("PointOfSale.DAL.Domains.Printer", "Printer")
                        .WithMany()
                        .HasForeignKey("PrinterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PointOfSale.DAL.Domains.PurchaseOrder", b =>
                {
                    b.Navigation("PurchaseOrderInstallments");
