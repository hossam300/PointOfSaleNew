...
namespace PointOfSale.BLL.BaseObjects
{
    ...
    public static class UnitOfWorkServiceCollectionExtensions
    {
        ...
        {
            services.AddTransient<IRePointOfSaleitoryFactory, UnitOfWork<TContext>>();
        ...
        /// <summary>
        /// Registers the custom rePointOfSaleitory as a service in the <see cref="IServiceCollection"/>.
        /// </summary>
        /// <typeparam name="TEntity">The type of the entity.</typeparam>
        /// <typeparam name="TRePointOfSaleitory">The type of the custom rePointOfSaleitry.</typeparam>
        /// <param name="services">The <see cref="IServiceCollection"/> to add services to.</param>
        /// <returns>The same service collection so that multiple calls can be chained.</returns>
        public static IServiceCollection AddCustomRePointOfSaleitory<TEntity, TRePointOfSaleitory>(this IServiceCollection services)
            where TEntity : class
            where TRePointOfSaleitory : class, IRePointOfSaleitory<TEntity>
        {
            services.AddScoped<IRePointOfSaleitory<TEntity>, TRePointOfSaleitory>();
